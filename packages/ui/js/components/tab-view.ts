...
import { cssTime, debounce, debug, frame, onoff, siblings, timeout } from '../internal/utils'
...
export class TabView extends HTMLElement {
  ...
  disconnectedCallback() {
    debug(`${TabView.name} ⚡️ disconnect`)
