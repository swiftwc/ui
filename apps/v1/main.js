              ...
              `
                  <${6 === root.querySelectorAll('scroll-view').length ? 'dialog is="sheet-view"' : 'body-view'}>
                    ...
                    <tool-bar>
                      ...
                      <tool-bar-item slot="navigation-bar-leading"><menu-view><label-view system-image="smiley" slot="label"></label-view><button tabindex="0">ddd</button></menu-view></tool-bar-item>
