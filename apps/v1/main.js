  ...
  if (event.target.closest('button')) {
                                    ...
                                    <dialog is="sheet-view">
                                      ...
                                      <dialog is="sheet-view">
                                        ...
                                        <tool-bar>
                                          ...
                                          <tool-bar-item slot="navigation-bar-leading"><picker-view picker-style="menu"><option slot="options" value="0" label="0%"></option><option slot="options" value="10" label="Minimum Tip"></option><option slot="options" value="20" label="Standard"></option><option slot="options" value="30" label="Generous"></option><option slot="options" value="50" label="Very Generous"></option></picker-view></tool-bar-item>

                                          <tool-bar-item-group slot="navigation-bar-leading"><tool-bar-item><menu-view><label-view system-image="smiley" slot="label"></label-view><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button></menu-view></tool-bar-item><tool-bar-item><button type="button" tabindex="0"><label-view><svg slot="image" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256"><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216ZM80,108a12,12,0,1,1,12,12A12,12,0,0,1,80,108Zm96,0a12,12,0,1,1-12-12A12,12,0,0,1,176,108Zm-1.07,48c-10.29,17.79-27.4,28-46.93,28s-36.63-10.2-46.92-28a8,8,0,1,1,13.84-8c7.47,12.91,19.21,20,33.08,20s25.61-7.1,33.07-20a8,8,0,0,1,13.86,8Z"></path></svg></label-view></button></tool-bar-item><tool-bar-item><button type="button" tabindex="0"><label-view system-image="smiley"></label-view></button></tool-bar-item></tool-bar-item-group>
    ...
    if (fwBtn) {
      ...
      await startViewTransition(event.target, 'forwards', async () => {
                  ...
                  <${'dialog' === tag ? `${tag} is="sheet-view"` : tag}>
                    <scroll-view>
                      <v-stack padding placement="leading fill">
                        ...
                        }<button type="button" class="bw">🔙</button><button type="button" class="fw">→</button><p>...</p><p>...</p><button type="button" class="bww">🔚</button><form method="dialog"><button>close</button></form><p>...</p><input type="text" /><p>...</p><menu-view><label-view system-image="smiley" slot="label"></label-view><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button></menu-view><p>...</p>
        ...
        <picker-view picker-style="menu"><option slot="options" value="0" label="0%"></option><option slot="options" value="10" label="Minimum Tip"></option><option slot="options" value="20" label="Standard"></option><option slot="options" value="30" label="Generous"></option><option slot="options" value="50" label="Very Generous"></option></picker-view>
        ...
        <p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><p>...</p><input type="text" /><p>...</p><p>...</p><p>...</p>
                    ...
                    <tool-bar>
                      ...
                      <tool-bar-item slot="navigation-bar-leading"><picker-view picker-style="menu"><option value="0" label="00%" slot="options"></option><option value="10" label="0Minimum Tip" slot="options"></option><option value="20" label="0Standard" slot="options"></option><option value="30" label="0Generous" slot="options"></option><option value="50" label="0Very Generous" slot="options"></option></picker-view></tool-bar-item>

                      <tool-bar-item slot="navigation-bar-leading">
                      <menu-view><label-view system-image="smiley" slot="label"></label-view><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button>
            ...
            <menu-view><label-view system-image="smiley" slot="label"></label-view><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button><button tabindex="0"><label-view title="ddd"></label-view></button></menu-view>
